      ...
      <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          {showNavDropdown && (
            ...
            >
              ...
              <div
                style={{ borderTop: "1px solid #1e1e1c", margin: "6px 0 2px" }}
              />
              <div
                style={{
                  fontFamily: "'DM Mono','Courier New',monospace",
              ...
              {Object.entries(ROUTE_LINKS)
                .flatMap(([dest, dl]) =>
                  (dl.routes || []).map((r) => ({ ...r, dest })),
                )
                .slice(0, 20)
                .map((r) => (
                  <button
              ...
              <div
                style={{ borderTop: "1px solid #1e1e1c", margin: "4px 0 2px" }}
              />
              <button
                onMouseDown={() => {
                  setShowAbout(true);
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = "none";
                  e.currentTarget.style.color = "#7a7a74";
                }}
              >
                ℹ About this tool
              </button>
            ...
            >
              <div
                style={{
                  ...
                  height: "100%",
                  background: "linear-gradient(90deg,#c49a38,#e8b84b)",
                  borderRadius: "1px",
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            ...
            <span style={{ letterSpacing: "0.5px", fontSize: "11px" }}>
              {LANGS.find((l) => l.code === lang)?.label.slice(0, 3) ||
                lang.toUpperCase()}
            </span>
            <svg
              width="7"
              ...
              {LANGS.map((l) => (
                <button
                  ...
                  onClick={() => {
                    setLang(l.code);
                    try {
                      localStorage.setItem("ctp_lang", l.code);
                    } catch (e) {}
                  ...
                  style={{
                    ...
                    width: "100%",
                    background:
                      lang === l.code ? "rgba(232,184,75,0.09)" : "transparent",
                    border: "none",
                    borderRadius: "7px",
                    padding: "8px 11px",
                    cursor: "pointer",
                    fontFamily: "'DM Mono','Courier New',monospace",
                    fontSize: "11px",
                    color: lang === l.code ? "#e8b84b" : "#9a9a94",
                    letterSpacing: "0.3px",
