    ...
    <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
                  ...
                  >
                    ...
                    {sub.type === "multi2" && (
                      <div>
                        ...
                        >
                          {(multiCombo[sub.id] || []).length}/{sub.max} selected
                          · optional
                        </div>
                      </div>
                    )}
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <button
                ...
                onMouseOver={(e) => {
                  if (canGo) e.currentTarget.style.opacity = "0.88";
                }}
                onMouseOut={(e) =>
                  (e.currentTarget.style.opacity = canGo ? "1" : "0.45")
                }
              >
      ...
      >
        ...
        >
          ...
          >
            {step === 1
              ? "100s of cycling trips filtered by ability, terrain and style"
              : "Month and region narrows to exact in-season matches"}
          </div>
        </div>
      </div>
    </div>
